...
import com.vighnesh.request.UpdateCartItemRequest;
import com.vighnesh.service.CartService;
...
public class CartController {
    ...
    @PutMapping("/cart/add")
    public ResponseEntity<CartItem> addItemToCart(@RequestBody AddCardItemRequest req,@RequestHeader("Authorization") String jwt)throws Exception{
