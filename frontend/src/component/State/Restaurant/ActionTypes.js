...
export const GET_RESTAURANTS_CATEGORIES_REQUEST = "GET_RESTAURANTS_CATEGORIES_REQUEST";
export const GET_RESTAURANTS_CATEGORIES_SUCCESS = "GET_RESTAURANTS_CATEGORIES_SUCCESS";
export const GET_RESTAURANTS_CATEGORIES_FAILURE = "GET_RESTAURANTS_CATEGORIES_FAILURE";

// Utility action to clear restaurant slice when user context changes
export const CLEAR_RESTAURANT_STATE = "CLEAR_RESTAURANT_STATE";
